...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.use_balanced_weights:
            classes_weights_path = os.path.join(Path.db_root_dir(args.dataset,kaggle=False), args.dataset+'_classes_weights.npy')
    ...
    def validation(self, epoch):
        ...
        Dice = self.evaluator.Dice_coef()/len(self.val_loader)
